...
setup(
    ...
    url="https://github.com/rcdalj/speech2speech",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="rcdalj",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="rcdalj1@gmail.com",  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/rcdalj/speech2speech/issues",
        "Source": "https://github.com/rcdalj/speech2speech",
    },
)